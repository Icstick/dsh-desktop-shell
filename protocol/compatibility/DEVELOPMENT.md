# Protocol Compatibility Development Contract

## Boundary

维护 Legacy/std/版本降级与 conformance matrix。 它只处理本模块列出的 ownership，不通过便利性绕过上层 policy、下层 abstraction 或 Adapter boundary。

## Data flow

```text
adapter results + fixtures
