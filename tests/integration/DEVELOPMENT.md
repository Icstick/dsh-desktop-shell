# Integration Tests Development Contract

## Boundary

验证 Supervisor、process、transport、adapter 和 provider 组合。 它只处理本模块列出的 ownership，不通过便利性绕过上层 policy、下层 abstraction 或 Adapter boundary。
