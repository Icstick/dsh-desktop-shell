# Unit Tests Development Contract

## Boundary

验证纯状态、validation、policy、redaction 和 negotiation。 它只处理本模块列出的 ownership，不通过便利性绕过上层 policy、下层 abstraction 或 Adapter boundary。
