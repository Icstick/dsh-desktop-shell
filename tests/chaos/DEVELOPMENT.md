# Chaos Tests Development Contract

## Boundary

注入 crash、port/PID、disconnect、provider failure 与 race。 它只处理本模块列出的 ownership，不通过便利性绕过上层 policy、下层 abstraction 或 Adapter boundary。
