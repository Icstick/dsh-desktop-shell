...
pub fn now_timestamp() -> String {
    now_timestamp_like(SystemTime::now())
}

/// [now_timestamp] for an explicit instant (used by the daemon credential
/// file, which stamps expiry/issue times).
pub fn now_timestamp_like(time: SystemTime) -> String {
