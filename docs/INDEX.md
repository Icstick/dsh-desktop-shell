...
- [Repository Map](code-map/REPOSITORY_MAP.md)
- [Current Status](../tracking/CURRENT.md)

## 产品

- [PRD](product/PRD.md)
- [User Journeys](product/USER_JOURNEYS.md)
- [Activity Rail](product/ACTIVITY_RAIL.md)
- [Non-functional Requirements](product/NFR.md)
...
- [Module Dependencies](code-map/MODULE_DEPENDENCIES.md)
- [Ownership Matrix](code-map/OWNERSHIP_MATRIX.md)
- [Interface Catalog](code-map/INTERFACE_CATALOG.md)
- [Protocol Overview](protocol/OVERVIEW.md)
- [Error Model](protocol/ERROR_MODEL.md)
