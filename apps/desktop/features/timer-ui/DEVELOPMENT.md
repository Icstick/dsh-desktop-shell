# Timer UI Development Contract

## Boundary

提供 Desktop countdown、stopwatch 与 pomodoro。 它只处理本模块列出的 ownership，不通过便利性绕过上层 policy、下层 abstraction 或 Adapter boundary。
