...
export const translations: Record<Lang, Record<TranslationKey, string>> = {
  zh: {
    ...
    "art.description.workbench": "浏览环境关联目录、查看文件；本片为只读视图（编辑在下一片）",
    "fs.subtitle": "环境关联的文件（只读）",
    "fs.empty": "这个目录是空的。",
  ...
  en: {
    ...
    "art.description.workbench": "Browse environment-linked directories and read files (read-only in this slice)",
    "fs.subtitle": "Environment-linked files (read-only)",
